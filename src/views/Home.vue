<template>
  <div class='home'>
    ...
    <template v-if="bStore">
      ...
      <ec-shop :preview="false" :data="productData"></ec-shop>
      <ec-shop-menu :preview="false"></ec-shop-menu>
    </template>
    <template v-else>
      <ec-tab-down v-if="!bHome"></ec-tab-down>
    </template>
...
import EcShop from 'components/shop/Frontend'
...
export default {
  ...
  computed: {
    ...
    bHome() {
      return this.oQuery.topic_id ? false : true
    },
    bStore() {

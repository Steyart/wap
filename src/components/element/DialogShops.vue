<template>
    <div class='dialog-ec dialog-shops'>
        <ec-dialog 
            ...
            <template v-if="selActive == 0">
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <ec-button type="primary" @click="closeDialog()">确定</ec-button>
                </div>
            </template>
            <template v-else>
    ...
    computed: {
        ...
        selectShopsId() {
            ...
            if (this.modulesIndex != -1) {
                ...
                if (allValue && allValue.hasOwnProperty('selectShopsId')) {
                    selectShopsId = allValue.selectShopsId
                }
            }
            return selectShopsId
        },
        selGoodNum() {
            console.log(this.selectShopsId)
            return this.selectShopsId.length
        },
        /**
         * 开发模式生效
         * 
...
@media only screen and (max-width: 1540px) {
    .dialog-shops ul.picture-list li figure {
        height: 11rem;
    }
}

<template>
    <div class='shop-signs'>
        <header>
            <img class="bg-img" :src="sStreetBg" alt="">
            <figure>
...
export default {
    ...
    beforeCreate() {
        ...
        this.$http
            .post(
                getUrl(`console&c=${window.apiAuthority}&a=storeIn`),
                qs.stringify({
        ...
        isFollow() {
            if (!this.preview) {
                this.$http
                    .post(
                        this.url(
                            `console&c=${window.apiAuthority}&a=addCollect`
                        ),
                        qs.stringify({
                            ruid: window.shopInfo.ruid
                        })

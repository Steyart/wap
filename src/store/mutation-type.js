...
const ON_OFF_DIALOG_SHOPS = 'dialogShops/onOffDialogGoods'
const SET_DIALOG_SHOPS = 'dialogShops/setDialogGoods'
const SELECT_SHOPS = 'dialogShops/SelectGoods'
const SET_DIALOG_SEL_SHOPS = 'dialogShops/setDialogSelGoods'
const REMOVE_SELECT_SHOPS = 'dialogShops/removeSelect'
const CLEAR_SEL_SHOPS = 'dialogShops/clearSelGoods'
...
export{
    ...
    ON_OFF_DIALOG_SHOPS,//开关 shops 弹出层
    SET_DIALOG_SHOPS,//店铺列表赋值
    SELECT_SHOPS,//选择店铺
    SET_DIALOG_SEL_SHOPS,//已选择店铺列表赋值
    REMOVE_SELECT_SHOPS,//移除已选中列表中的店铺
    CLEAR_SEL_SHOPS,//清空已选项
}